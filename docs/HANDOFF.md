...
## Stand
- Letzte Aktualisierung: 19.09.2026, von Claude Code (O1 entschieden: W = A = 60 s; Schwellen neu, Prüfbarkeit von außen, App-Schnitt; gelöscht als erledigt: Korridor-Veto (durch O1 aufgehoben), ANSPRUCH-Zusatzzeile (hinfällig), Offen 5 alt).
...
| 10 | Basisraten-Linie: (a) festschreiben, nur Feld, (b) Client-Schätzung, (c) weglassen. O1 ist entschieden (W = A = 60 s); offen ist nur noch die Basisrate. Ohne Antwort bis Sa 12:00 UTC baue ich (c) | Dinkelberg | Sa 19.09. |
...
- **Schwellen, 19.09. neu geeicht auf 30 Tage** (Ziel 45 %, Band 30–70 %; die 60-Tage-Rate muss im Band liegen). Bei n = 22 geht die Rate in Schritten von 4,5 Punkten, deshalb landen alle bei 50 statt 45:
  ...
  | BTC | 1,30 % | 50 / 34 / 38 % | 0,30 % | 50 / 44 / 46 % |
  | ETH | 1,20 % | 50 / 39 / 47 % | 1,00 % | 50 / 31 / 35 % |

  Die Tabelle vom 18.09. (1,75/1,0, 1,25/0,5, 1,5/0,75) ist damit ersetzt. Am Wochenende bewegt sich BTC kaum, 0,30 % ist ehrlich, fühlt sich aber klein an.
