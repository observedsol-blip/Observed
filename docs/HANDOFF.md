...
| 19.09. | Claude Code → Spec/Chat | Spec §3: Der Referenzpreis sei „beim Versiegeln **niemandem** bekannt“ | Mit A = 60 s darf der fixierte Wert bis zu 60 s **vor** Abgabeschluss (04:00) veröffentlicht sein. Wer in der letzten Minute versiegelt, kennt ihn im ungünstigsten Fall; in `reading_age_is_measured_at_submission` ist das getestet | Satz ist so nicht mehr wahr. Der Vorteil ist der Kurs der letzten Minute gegenüber 12 h bis zum Ergebnis. Benannt in 01 §5b, SECURITY.md und Spec-Vorschlag 15. Wer es verhindern will, müsste das Versiegeln A Sekunden vor der Referenz schließen, also um 03:59; das wäre eine Programmänderung vor Saisonstart |
