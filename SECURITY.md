...
- **`Round` und `Player` sind nie schließbar.** Rund 0,267 SOL pro Saison bleiben als Miete gebunden (64 × 472 B seit Terms v3; vorher 0,218), dazu 0,0013 SOL pro Gerät für `Player`. Eine `close_round`-Instruktion wäre neue Angriffsfläche für eine Ersparnis unterhalb der Reviewkosten.
